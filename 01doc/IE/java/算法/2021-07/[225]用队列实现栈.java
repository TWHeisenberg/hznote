...
class MyStack {
    ...
    public int pop() {
      Queue<Integer> storeQueue = queueA.isEmpty() ? queueB : queueA;
      Queue<Integer> transferQueue = queueA.isEmpty() ? queueA : queueB;

      Integer v;
      while((v = storeQueue.poll()) != null && !storeQueue.isEmpty()){
        transferQueue.add(v);
      }
      return v;
    }
